...
* ```DL_MP1.ipynb```: Python notebook in which the project was devellopded. Contains all the figures (and more) presented in the report.

* ```test.py```: Python script that can be run without argument. It will train each one of the 4 models over 200 epochs with an auxiliary loss weighting of f=0.5. Its execution time is 322 sec on a dual core 2 GHz _Intel Core i5_.
